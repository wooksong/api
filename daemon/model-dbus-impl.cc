 ...
 */
static gboolean
gdbus_cb_model_register (MachinelearningServiceModel *obj, GDBusMethodInvocation *invoc,
    const gchar *name, const gchar *path, const bool is_active, const gchar *description)
{
  int ret = 0;
  guint version = 0U;
